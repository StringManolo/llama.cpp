...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o: /root/llama.cpp/tests/test-model-load-cancel.cpp
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.o"
...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.i: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/llama.cpp/tests/test-model-load-cancel.cpp > CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.i
...
tests/CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.s: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/llama.cpp/tests/test-model-load-cancel.cpp -o CMakeFiles/test-model-load-cancel.dir/test-model-load-cancel.cpp.s

tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/flags.make
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: /root/llama.cpp/tests/get-model.cpp
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o: tests/CMakeFiles/test-model-load-cancel.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.o"
...
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.i: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/llama.cpp/tests/get-model.cpp > CMakeFiles/test-model-load-cancel.dir/get-model.cpp.i
...
tests/CMakeFiles/test-model-load-cancel.dir/get-model.cpp.s: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/llama.cpp/tests/get-model.cpp -o CMakeFiles/test-model-load-cancel.dir/get-model.cpp.s
...
bin/test-model-load-cancel: /usr/lib/libcurl.so
...
bin/test-model-load-cancel: tests/CMakeFiles/test-model-load-cancel.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable ../bin/test-model-load-cancel"
	cd /root/llama.cpp/armv7/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-model-load-cancel.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test-model-load-cancel.dir/clean:
	cd /root/llama.cpp/armv7/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/test-model-load-cancel.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test-model-load-cancel.dir/clean

tests/CMakeFiles/test-model-load-cancel.dir/depend:
	cd /root/llama.cpp/armv7/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/llama.cpp /root/llama.cpp/tests /root/llama.cpp/armv7/build /root/llama.cpp/armv7/build/tests /root/llama.cpp/armv7/build/tests/CMakeFiles/test-model-load-cancel.dir/DependInfo.cmake "--color=$(COLOR)"
