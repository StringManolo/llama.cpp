...
tests/CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.o: /root/llama.cpp/tests/test-llama-grammar.cpp
tests/CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.o: tests/CMakeFiles/test-llama-grammar.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.o"
...
tests/CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.i: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/llama.cpp/tests/test-llama-grammar.cpp > CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.i
...
tests/CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.s: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/llama.cpp/tests/test-llama-grammar.cpp -o CMakeFiles/test-llama-grammar.dir/test-llama-grammar.cpp.s

tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.o: tests/CMakeFiles/test-llama-grammar.dir/flags.make
tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.o: /root/llama.cpp/tests/get-model.cpp
tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.o: tests/CMakeFiles/test-llama-grammar.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.o"
	cd /root/llama.cpp/armv7/build/tests && ccache /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.o -MF CMakeFiles/test-llama-grammar.dir/get-model.cpp.o.d -o CMakeFiles/test-llama-grammar.dir/get-model.cpp.o -c /root/llama.cpp/tests/get-model.cpp
...
tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.i: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/llama.cpp/tests/get-model.cpp > CMakeFiles/test-llama-grammar.dir/get-model.cpp.i
...
tests/CMakeFiles/test-llama-grammar.dir/get-model.cpp.s: cmake_force
	...
	cd /root/llama.cpp/armv7/build/tests && /usr/bin/ccache  g++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/llama.cpp/tests/get-model.cpp -o CMakeFiles/test-llama-grammar.dir/get-model.cpp.s
...
bin/test-llama-grammar: /usr/lib/libcurl.so
...
bin/test-llama-grammar: tests/CMakeFiles/test-llama-grammar.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/root/llama.cpp/armv7/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX executable ../bin/test-llama-grammar"
	cd /root/llama.cpp/armv7/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-llama-grammar.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/test-llama-grammar.dir/clean:
	cd /root/llama.cpp/armv7/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/test-llama-grammar.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/test-llama-grammar.dir/clean

tests/CMakeFiles/test-llama-grammar.dir/depend:
	cd /root/llama.cpp/armv7/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/llama.cpp /root/llama.cpp/tests /root/llama.cpp/armv7/build /root/llama.cpp/armv7/build/tests /root/llama.cpp/armv7/build/tests/CMakeFiles/test-llama-grammar.dir/DependInfo.cmake "--color=$(COLOR)"
